...
namespace CodeGenTests {
	...
	public:
		...
		TEST_METHOD(ValidateDerefs)
		{
			const wchar_t* c_expected = L"0123456789aaaaa373737373700.5x3711.5x3722.5x3733.5x3744.5x37112136115439012345678902468101214161812.5a373712.5a373710039.288b5759317312.5a3737371317.25c37371317.25c3737";
			TestOutputWithExpected(c_expected, "ValidateDerefs.txt");
		}
	};
}